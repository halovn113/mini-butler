...
class TestMoodEnum:
    def test_all_moods_exist(self):
        from butler.interface.tui.mood import Mood
    ...
    def test_mood_faces(self):
        from butler.interface.tui.mood import Mood, MOOD_FACES
    ...
    def test_mood_labels(self):
        from butler.interface.tui.mood import Mood, MOOD_LABELS
        for mood in Mood:
            assert mood in MOOD_LABELS

    def test_mood_css_classes(self):
        from butler.interface.tui.mood import Mood, MOOD_CSS_CLASS, ALL_MOOD_CLASSES
        for mood in Mood:
    ...
    def test_all_mood_classes_matches_dict(self):
        from butler.interface.tui.mood import MOOD_CSS_CLASS, ALL_MOOD_CLASSES
...
class TestMoodRawComputation:
    ...
    def _make(self):
        from butler.interface.tui.mood import MoodStateMachine
...
class TestMoodHysteresis:
    ...
    def test_transition_after_sustained(self):
        ...
        from butler.interface.tui.mood import Mood, _HYSTERESIS_SECONDS
        m = self._make()
...
class TestMoodHistory:
    ...
    def history(self, tmp_path: Path):
        from butler.interface.tui.mood import MoodHistory
        h = MoodHistory()
    ...
    def test_rolling_prune(self, history):
        from butler.interface.tui.mood import Mood, _MAX_HISTORY
    ...
    def test_log_transition_not_initialized(self):
        ...
        from butler.interface.tui.mood import MoodHistory, Mood
        h = MoodHistory()
...
class TestMoodMachineHistory:
    def test_transition_logs_to_history(self, tmp_path: Path):
        from butler.interface.tui.mood import MoodStateMachine, Mood, _HYSTERESIS_SECONDS
        m = MoodStateMachine()
...
class TestMoodTUIIntegration:
    def test_system_status_no_duplicate_mood_indicator(self):
        ...
        from butler.interface.tui.panels.system import SystemStatus
        panel = SystemStatus()
    ...
    def test_all_mood_classes_set(self):
        from butler.interface.tui.mood import ALL_MOOD_CLASSES
...
class TestMoodCLI:
    def test_mood_history_arg_exists(self):
        ...
        from butler.__main__ import main
        import sys
...
class TestMoodSingleton:
    def test_singleton_exists(self):
        from butler.interface.tui.mood import mood_machine, MoodStateMachine
        assert isinstance(mood_machine, MoodStateMachine)

    def test_singleton_starts_chill(self):
        from butler.interface.tui.mood import mood_machine, Mood
