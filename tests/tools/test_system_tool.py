...
class TestShellResult:
    ...
    def test_success_true_when_rc_zero(self):
        from butler.tools.system_tool import ShellResult
...
class TestDangerousCommandError:
    ...
    def test_is_runtime_error(self):
        from butler.tools.system_tool import DangerousCommandError
...
class TestRunSafeMode:
    ...
    def _tool(self):
        from butler.tools.system_tool import SystemTool
        return SystemTool()
...
class TestModuleSingleton:
    ...
    def test_system_tool_singleton_exists(self):
        from butler.tools.system_tool import system_tool, SystemTool
        assert isinstance(system_tool, SystemTool)

    def test_singleton_is_reused(self):
        from butler.tools.system_tool import system_tool as a
        from butler.tools.system_tool import system_tool as b
        assert a is b
