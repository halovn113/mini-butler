...
class TestAwarenessState:
    def test_defaults(self):
        from butler.agent.awareness import AwarenessState
        s = AwarenessState()
...
class TestRollingBuffer:
    def test_buffer_maxlen(self):
        ...
        from butler.agent.awareness import AwarenessCollector, AwarenessState
    ...
    def test_latest_is_none_when_empty(self):
        from butler.agent.awareness import AwarenessCollector
...
class TestSubprocessHelpers:
    def test_xdotool_not_found(self):
        from butler.agent.awareness import _get_active_window_title
    ...
    def test_get_process_xdotool_missing(self):
        from butler.agent.awareness import _get_active_window_process
    ...
    def test_xclip_not_found(self):
        from butler.agent.awareness import _get_clipboard
    ...
    def test_grim_not_found(self):
        from butler.agent.awareness import _capture_screenshot
