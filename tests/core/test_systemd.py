...
class TestCheckLinger:
    ...
    def test_linger_enabled(self):
        from butler.cli.setup import _check_linger
...
class TestEnsureLinger:
    def test_already_enabled_no_prompt(self):
        from butler.cli.setup import _ensure_linger
...
class TestSystemctl:
    def test_success(self):
        from butler.cli.setup import _systemctl
    ...
    def test_no_os_system_in_systemd_code(self):
        ...
        import inspect
        from butler.cli import setup as mod
...
class TestVerifyService:
    def test_active(self):
        from butler.cli.setup import _verify_service
...
class TestFormatUptime:
    def test_parse_with_weekday(self):
        from butler.cli.setup import _format_uptime
...
class TestSystemdCheck:
    def test_no_service_file(self, tmp_path):
        from butler.cli.setup import _systemd_check
...
class TestSetupSystemd:
    def test_writes_service_file(self, tmp_path):
        from butler.cli.setup import _setup_systemd
