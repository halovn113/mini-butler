...
log = logging.getLogger("butler.tool.computer_use")
...
class ComputerUseTool(BaseTool):
    ...
    def _get_loop(self):
        if self._loop is None:
            from butler.vision.computer_use import vision_loop
    ...
    async def execute(self, **kwargs: Any) -> ToolResult:
        ...
        from butler.vision.computer_use import VisionGoal
...
from butler.tools import registry as _registry  # noqa: E402
