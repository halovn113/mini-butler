"""
Butler v2 — FeedTool: RSS/Atom feed parser (#289)
...
Usage:
    from butler.tools.feed_tool import feed_tool
...
log = logging.getLogger("butler.tool.feed")
...
def parse_feed(xml_text: str, source_name: str = "") -> list[FeedItem]:
    ...
    except defusedxml.common.DefusedXmlException as exc:
        raise FeedToolError(
            f"Security error parsing feed XML: {exc}. "
            "XML contains potential XXE or other dangerous entities."
        ) from exc
