...
Usage:
    python -m butler.interface.telegram_bot
...
async def cmd_haber(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    try:
        from butler.tools.news import NewsTool
...
async def cmd_research(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    try:
        from butler.tools.web_search import execute_web_research
...
async def cmd_news(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    try:
        from butler.tools.web_search import execute_web_news
