...
def resolve_date(text: str, now: datetime | None = None) -> Optional[datetime]:
    ...
    for day_name, weekday_idx in _WEEKDAYS.items():
        if day_name in t:
