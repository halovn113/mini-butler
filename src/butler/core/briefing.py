...
from butler.core.profile import profile as _profile
from butler.core.habits import habits as _habits
...
class Briefing:
    ...
    def _clear_overnight_cache(self) -> None:
        ...
        try:
            from butler.agent.workflows.overnight_poll import clear_overnight_data
    ...
    async def _get_weather(self) -> Optional[str]:
        try:
            from butler.tools.weather import WeatherTool
            w = WeatherTool()
    ...
    async def _get_classroom(self) -> Optional[str]:
        try:
            from butler.tools.classroom import ClassroomTool
            c = ClassroomTool()
    ...
    async def _get_next_class(self, now: datetime) -> Optional[str]:
        ...
        try:
            from butler.core.places import places as _places
