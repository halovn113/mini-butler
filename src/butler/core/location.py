"""
Butler v2 — Location Service

Priority order:
1. .env manual override (BUTLER_CITY, BUTLER_LAT, BUTLER_LON)
...
class LocationService:
    ...
    async def _resolve(self) -> Location:
        # 1. Manual .env override (BUTLER_CITY / BUTLER_LAT / BUTLER_LON)
    ...
    def _from_config(self) -> Optional[Location]:
        """Read BUTLER_CITY / BUTLER_LAT / BUTLER_LON from config."""
