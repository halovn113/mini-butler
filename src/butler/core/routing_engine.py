...
from butler.core.date_parser import resolve_date
from butler.core.prompt_builder import COMMAND_SYSTEM
from butler.data import data_layer
from butler.llm.ollama import ollama
from butler.tools import registry

log = logging.getLogger("butler.routing_engine")
...
async def dispatch_internal(
    ...
    *,
    ...
    if tool == "_tts_stop":
        ...
        try:
            from butler.agent.ambient import ambient_analyzer
        ...
        try:
            from butler.agent.proactive import (
        ...
        from butler.core.briefing import briefing as _briefing
        ...
        from butler.core.schedule import schedule as _sched
...
async def execute_plan(
    ...
    *,
    ...
    """
    from butler.agent.planner import planner_agent
    from butler.agent.executor import plan_executor
    ...
    if len(steps) == 1:
        log.info("execute_plan: single-step plan — executing directly (tool=%s)", steps[0].tool)
    ...
    try:
        from butler.core.notification_manager import notify_toast
        notify_toast(
    ...
    try:
        from butler.core.notification_manager import notify_toast as _toast
    ...
    from butler.core.finalizer import finalize_plan
