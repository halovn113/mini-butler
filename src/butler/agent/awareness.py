...
log = logging.getLogger("butler.awareness")

_SCREENSHOT_PATH = "/tmp/butler_awareness_latest.png"
...
class AwarenessCollector:
    ...
    def get_current_context(self) -> str:
        ...
        Example output::
            ...
            [Awareness] Active window: VS Code (code) | Clipboard: "def foo():" | Screenshot: /tmp/butler_awareness_latest.png
        """
        if not self._buffer:
            return ""
