...
if TYPE_CHECKING:
    from butler.agent.interventions import Intervention
...
_TUI_IDENTIFIERS = {"butler", "python", "python3"}
...
class Notifier:
    ...
    def _should_skip(self, intervention: "Intervention") -> tuple[bool, str]:
        ...
        try:
            from butler.agent.interventions import intervention_queue, Priority
    ...
    def dispatch(self, intervention: "Intervention") -> bool:
        ...
        title = f"Butler: {intervention.title}"
